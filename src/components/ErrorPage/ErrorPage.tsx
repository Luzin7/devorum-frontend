...
export function ErrorPage(): ReactElement {
  ...
  return (
    <div className="w-screen h-screen flex flex-col items-center justify-center gap-8 text-center">
      ...
      <p className="text-sm w-4/5 lg:text-base">
      ...
      <p className="text-5xl font-bold lg:text-8xl">{status}</p>
      <Link to={HOME}>
        <button
          type="button"
          className="bg-secondary py-4 px-5 rounded-full text-text font-bold hover:text-primary hover:scale-105
        transition-all"
        >
